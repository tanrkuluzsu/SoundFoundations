// src/lib.rs
/*
 * Core library for SoundFoundations
 */
...
#[derive(Debug)]
pub struct SoundFoundationsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SoundFoundationsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SoundFoundations processing");
    
    let mut processor = SoundFoundationsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SoundFoundationsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SoundFoundationsProcessor::new(false);
